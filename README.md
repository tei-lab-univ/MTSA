...
## How to install ##
You can run MTSA using JAVA. Just download the lastest jar file from the [downloads](https://git.exactas.uba.ar/lafhis/mtsa/-/releases) section and run it.

## Getting started ##
To learn how to use MTSA or get involved in contributing to its code, refer to our [wiki](https://git.exactas.uba.ar/lafhis/mtsa/-/wikis/home).
