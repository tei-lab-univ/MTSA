...
public class FluentImpl implements Fluent {
	...
	private String name;
	public Set<Symbol> initiatingActions;
	public Set<Symbol> terminatingActions;
	...
	@Override
	public void setInitiatingActions(Set<Symbol> actions) { this.initiatingActions = actions; }
	public void setTerminatingActions(Set<Symbol> actions) { this.terminatingActions = actions; }
	...
	public String toString() {
		...
		result.append(this.getName()).append(" = <").
			append(this.getInitiatingActions()).append(" , ").
				append(this.getTerminatingActions()).append(" > initially ").append(this.getInitialValue());
