...
public class LegalityWindow extends JDialog { //JFrame {
    ...
    public LegalityWindow(HPWindow window, LegalityOptions options) {
    	...
    	initComponents(options.machines, options.labels);
    ...
    private void buttonCheckActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        //actionCheckBoxes
        this.legalityOptions.actionSet = actionCheckBoxes.stream()
    ...
    protected void initComponents(Vector<CompactState> machines, ArrayList<String> labels) {
       ...
       // jLlabelModelsToCheck = new JLabel();
        ...
        // init a list of checkboxes
        //JList actionList = new javax.swing.JList<String>(labels.toArray(new String[0]));
        //actionList.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.GRAY));

        // checkbox version
        JPanel actionsPanel = new JPanel();
        actionsPanel.setLayout(new BoxLayout(actionsPanel, BoxLayout.Y_AXIS));
        actionsPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Select controllable actions"));

        // Wrap actionsPanel in a JScrollPane
        JScrollPane actionsScrollPane = new JScrollPane(actionsPanel);
        actionsScrollPane.setPreferredSize(new java.awt.Dimension(150, 200)); // Adjust height as needed




        actionCheckBoxes = new ArrayList<>();
...
//                .add(jLlabelModelsToCheck)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(actionsScrollPane, GroupLayout.PREFERRED_SIZE, 300, GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(GroupLayout.BASELINE)
                    //.add(labelActions)
                    .add(actionsScrollPane, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
    ...
    ArrayList<JCheckBox> actionCheckBoxes;
