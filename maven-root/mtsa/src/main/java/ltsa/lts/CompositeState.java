...
public class CompositeState{
	...
	public boolean isCompositional = false;
	 ...
	 * alphabet.
	 */
	private Set<String> componentAlphabet;
	...
	public Set<String> getComponentAlphabet() {
		return componentAlphabet;
	}

	public void setComponentAlphabet(Set<String> componentAlphabet) {
	...
	public void applyOperations(LTSOutput output, Statistics...stats) throws Exception {
		...
		if(isCompositional){
			TransitionSystemDispatcher.CompositionalApproach(this, output, stats);
            applyHiding();
		}
	...
	public boolean checkProgress(LTSOutput output) {
		ProgressCheck cc;
    ...
    alphaStop = new CompactState(name);
