...
public class LTSAdapter<State, Action> implements LTS<State, Action> {
	...
	public HashMap<Integer, String> buildStateToRoleMap() {
		MTSImpl<State, Action> mtsImpl = (MTSImpl<State, Action>) mts;
		return mtsImpl.buildStateToRoleMap();
	}
  ...
  public int getNumberOfTransitions() { return mts.getNumberOfTransitions(); };
}
