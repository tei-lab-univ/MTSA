...
public class MTSAdapter<State, Action> implements MTS<State, Action> {
	...
	@Override
	public int getNumberOfTransitions() { return lts.getNumberOfTransitions(); }
	...
	public Set<Long> getWinningStatesOfOriginalEnv() { throw new UnsupportedOperationException("This operation is not supported."); }
