...
public class DebuggingAbstraction<State, Action>  implements OneCompostateAbstraction<State, Action> {
    /**
     ...
     */
    private class DebuggingRanker implements Comparator<Recommendation<State, Action>> {
