...
public class Alphabet<Action> implements Iterable<HAction<Action>> {
     ...
     */
    public <State> Alphabet(DirectedControllerSynthesisGR1<State, Action> directedControllerSynthesisGR1, List<LTS<State, Action>> ltss) {
        ...
        for (Action label : labels) {
            ...
            if (code == null) {
                HAction<Action> value = new HAction<>(directedControllerSynthesisGR1, this, label);
